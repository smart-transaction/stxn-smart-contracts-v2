...
#
#   # LESTNET verification without constructor
#   ./verify.sh lestnet MyContract 0x987654321fedcba
#
#   # LESTNET verification with constructor
#   ./verify.sh lestnet MyContract 0x987654321fedcba "constructor(string)" "hello"
